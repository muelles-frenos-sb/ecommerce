<div class="block-zone__widget">
    <div class="block-zone__widget-header">
        <div class="block-zone__tabs">
            <button class="block-zone__tabs-button block-zone__tabs-button--active" type="button">Destacados</button>
            <button class="block-zone__tabs-button" type="button">Más vendidos</button>
            <button class="block-zone__tabs-button" type="button">Populares</button>
        </div>
