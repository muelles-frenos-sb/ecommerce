        ...
        <div class="container">
            <div class="order-success__body">
                <div class="order-success__header">
                    ...
                    <h1 class="order-success__title"><?php echo $titulo; ?></h1>
                    <div class="order-success__subtitle"><?php echo $subtitulo; ?></div>
                ...
                <div class="card order-success__meta">
                    <ul class="order-success__meta-list">
                        <li class="order-success__meta-item">
                            ...
                            <span class="order-success__meta-value"><?php echo $transaccion->reference; ?></span>
                        </li>
                        <li class="order-success__meta-item">
                            <span class="order-success__meta-title">Creado en:</span>
                            <span class="order-success__meta-value"><?php echo $transaccion->created_at; ?></span>
                        </li>
                        <li class="order-success__meta-item">
                            <span class="order-success__meta-title">Total:</span>
                            <span class="order-success__meta-value"><?php echo formato_precio($transaccion->amount_in_cents/100); ?></span>
                        </li>
                        <li class="order-success__meta-item">
                            <span class="order-success__meta-title">Forma de pago:</span>
                            <span class="order-success__meta-value"><?php echo $transaccion->payment_method_type; ?></span>
                        </li>
                    </ul>
                </div>
                <div class="card">
