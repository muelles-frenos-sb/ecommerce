...
<link rel="stylesheet" href="<?php echo base_url(); ?>css/style.header-spaceship-variant-one.css" media="(min-width: 1200px)">
<link rel="stylesheet" href="<?php echo base_url(); ?>css/style.mobile-header-variant-one.css" media="(max-width: 1199px)">
